    ...
    return (
        <DQuestionLayout>
            ...
            <input
                ...
                className={`my-3 mx-4 p-3 border-2 rounded-md bg-gray-400/10 outline-none border-b font-body border-gray-200 focus:border-black/30 focus:ring-0 border-0`}
            />
